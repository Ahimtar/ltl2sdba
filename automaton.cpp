...
VWAA::ac_representation VWAA::mark_transformation(std::map<acc_mark, unsigned>& tgba_mark_owners) {
...
void VWAA::print_hoaf() {
    ...
    std::cout << "name: \"Automaton for " << spot::unabbreviate(simp.simplify(phi), "WM") << "\"\n";
